...
$icon = $row['icon'] ?? '';
$degree = $row['degree'] ?? '';
$institude = $row['institude'] ?? ''; // Fixed column name
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $icon = $_POST['icon'];
    $degree = $_POST['degree'];
    $institude = $_POST['institude']; // Fixed variable name
...
<body>
    ...
    <form id="updateForm" method="POST">
        ...
        <input type="text" name="institude" id="institude" value="<?= $institude ?>"><br> <!-- Fixed variable name -->
