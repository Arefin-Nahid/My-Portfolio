            ...
            <tr>
                <td>
                    <div class="left flex-1 flex justify-center">
                        ...
                        ?>
                        <img src="<?=$data['icon']?>" alt="" width="300px">
                    </div>
                </td>
                <td>
                    <div class="container">
            ...
            <tr>
                <td>
                    <div class="flex-1">
                        ...
                        $data = $stmt->fetch(PDO::FETCH_ASSOC);
                        ?>
                        <img class="about-me-img" src="<?=$data["image"]?>" alt="" width="300px" height="auto">
                    </div>
                </td>
                <td>
                    <div class="container">
            ...
            <tr>
                <td colspan="2">
                    <div class=about-button>
                        <button onclick="window.location.href='./crud/update_home.php'">Update Info</button>
                    </div>
                </td>
            </tr>
        </table>
